    ...
    mainWindow.setThumbarButtons([
        {
            ...
            click: function() {
                mediaDownVote(mainWindow.getBrowserView(), createThumbar(mainWindow, type, thumbsReverse)); 
            }
        },
        {
        ...
        },
        {
            ...
            click: function() {
                mediaUpVote(mainWindow.getBrowserView(), createThumbar(mainWindow, type, thumbsReverse));
            }
       }
    ]);
}
